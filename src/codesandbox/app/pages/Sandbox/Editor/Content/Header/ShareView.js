...
import {
  ...
  sandboxUrl,
  embedUrl,
} from 'codesandbox/app/utils/url-generator';

import type { Sandbox, Directory, Module } from 'codesandbox/common/types';

import Preference from 'codesandbox/app/components/Preference';
