...
import type { Sandbox, User } from 'codesandbox/common/types';
import sandboxActionCreators from 'codesandbox/app/store/entities/sandboxes/actions';
import { modulesFromSandboxNotSavedSelector } from 'codesandbox/app/store/entities/sandboxes/modules/selectors';
import { usersSelector } from 'codesandbox/app/store/entities/users/selectors';
import { isPatronSelector } from 'codesandbox/app/store/user/selectors';
...
import { tosUrl, privacyUrl } from 'codesandbox/app/utils/url-generator';
