...
import ConfirmLink from 'codesandbox/app/components/ConfirmLink';
import GithubBadge from 'codesandbox/app/components/sandbox/GithubBadge';
import { sandboxUrl, githubRepoUrl, profileUrl } from 'codesandbox/app/utils/url-generator';
import UserWithAvatar from 'codesandbox/app/components/user/UserWithAvatar';
import Stats from 'codesandbox/app/components/sandbox/Stats';
import PrivacyStatus from 'codesandbox/app/components/sandbox/PrivacyStatus';
import getTemplateDefinition from 'codesandbox/common/templates';

import type { User, GitInfo } from 'codesandbox/common/types';
